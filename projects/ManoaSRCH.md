...
layout: project
type: project
image: ../img/pictures/allUsersHome.png
title: "Manoa SRCH"
date: 2026-05-06
published: true
labels:
...
summary: "The Socially Responsible Computing Handbook (SRCH) is an evolving collection of content intended to support instructors. However, it is not designed as a traditional textbook for a single course. Instead, it is a resource where instructors are expected to select relevant material and apply it to their own courses"
---
...
<div style="text-align:center;"> <img src="../img/pictures/allUsersHome.png" alt="Essay image" style="width:600px;"> </div>
...
<div style="text-align:center;"> <img src="../img/pictures/userObjectives.png" alt="Essay image" style="width:600px;"> </div>
...
<div style="text-align:center;"> <img src="../img/pictures/adminObjCRUD.png" alt="Essay image" style="width:600px;"> </div>
